(function() {
  ...
  TuinSlider.prototype.bindEvents = function() {
    ...
    if (this.settings.pagination) {
      var paginationLinks = document.querySelectorAll('.b-slider-navigation li a');
  ...
  TuinSlider.prototype.appendArrows = function() {
    ...
    arrows.setAttribute('class', 'b-slider-controls');
    ...
    var controlsElement = this.el.querySelector('.b-slider-controls');
  ...
  TuinSlider.prototype.appendPagination = function() {
    ...
    this.settings.paginationHtml.setAttribute('class', 'b-slider-navigation');
